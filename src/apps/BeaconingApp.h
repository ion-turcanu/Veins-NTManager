...
#ifndef APPS_BEACONINGAPP_H_
#define APPS_BEACONINGAPP_H_
...
/**
 * @brief
 * Beaconing application class based on DemoBaseApplLayer.
 */

class VEINS_API BeaconingApp : public BaseApplLayer {

public:
    ~BeaconingApp() override;
...
protected:
    ...
    /** @brief this function is called upon receiving a BeaconMessage, also referred to as a beacon  */
    virtual void onBSM(BeaconMessage* bsm){};
...
protected:
    ...
    int startBeaconingAt;

};

} // namespace veins

#endif /* APPS_BEACONINGAPP_H_ */
